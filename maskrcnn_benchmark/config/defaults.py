...
# LSTFE
_C.MODEL.VID.LSTFE = CN()
_C.MODEL.VID.LSTFE.MIN_OFFSET = -12
_C.MODEL.VID.LSTFE.MAX_OFFSET = 12
_C.MODEL.VID.LSTFE.ALL_FRAME_INTERVAL = 25
_C.MODEL.VID.LSTFE.KEY_FRAME_LOCATION = 12
_C.MODEL.VID.LSTFE.GLOBAL_FRAME_NUM = 2

_C.MODEL.VID.LSTFE.MEMORY = CN()
_C.MODEL.VID.LSTFE.MEMORY.ENABLE = True
_C.MODEL.VID.LSTFE.MEMORY.SIZE = 25

_C.MODEL.VID.LSTFE.GLOBAL = CN()
_C.MODEL.VID.LSTFE.GLOBAL.RES_STAGE = 1
_C.MODEL.VID.LSTFE.GLOBAL.ENABLE = True
_C.MODEL.VID.LSTFE.GLOBAL.SIZE = 10
_C.MODEL.VID.LSTFE.GLOBAL.SHUFFLE = True

_C.MODEL.VID.LSTFE.REF_NUM_LOCAL = 2
_C.MODEL.VID.LSTFE.REF_NUM_GLOBAL = 2

_C.MODEL.VID.LSTFE.RATIO = 0.2

_C.MODEL.VID.LSTFE.SELECT = CN()
_C.MODEL.VID.LSTFE.SELECT.ENABLE = False

_C.MODEL.VID.LSTFE.ALIGN = CN()
_C.MODEL.VID.LSTFE.ALIGN.ENABLE = False
