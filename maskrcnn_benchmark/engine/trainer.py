...
def do_train(
    ...
    writer = SummaryWriter(log_dir='logs/llliii')


    logger = logging.getLogger("lstfe.trainer")
    ...
    for iteration, (images, targets, _) in enumerate(data_loader, start_iter):
        ...
        if not cfg.MODEL.VID.ENABLE:  # true
            images = images['cur'].to(device)
        else:
            images["cur"] = images["cur"].to(device)
            for key in ("ref", "ref_l", "ref_g"):
        ...
        writer.add_scalar(tag="loss_num", 
                scalar_value=losses,  
